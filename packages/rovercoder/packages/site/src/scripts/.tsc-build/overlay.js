...
export function openOverlay(elementToAdd, extraArguments) {
...
export function closeOverlayLast(args) {
    if (args == null || typeof args !== 'object') {
...
export function closeOverlays(args) {
    if (args == null || typeof args !== 'object') {
        console.error('Arguments invalid!');
        return false;
    }
