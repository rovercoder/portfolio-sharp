...
export function initializeManagedLifecycleObject(args) {
    if (args == null) {
...
export function destroyManagedLifecycleObject(args) {
    if (args == null) {
        console.error('Arguments are undefined!');
        return;
    }
...
export function destroyAllManagedLifecycleObjects(args) {
    if (args == null) {
        console.error('Arguments are undefined!');
        return;
    }
...
function _destroyManagedLifecycleObjects(args) {
    if (args == null) {
        console.error('Arguments are undefined!');
        return;
    }
...
export function destroyManagedLifecycleObjectComponent(component) {
